...
PARAM_DEFINE_STATIC_VMEM(PARAMID_CRYPTO_KEY1,              crypto_key1,             PARAM_TYPE_DATA,   32, sizeof(uint8_t),  PM_HWREG | PM_CRYPT, crypto_key_generate, NULL, crypto, 0x40, "Encryption key 1");
PARAM_DEFINE_STATIC_VMEM(PARAMID_CRYPTO_KEY2,              crypto_key2,             PARAM_TYPE_DATA,   32, sizeof(uint8_t),  PM_HWREG | PM_CRYPT, crypto_key_generate, NULL, crypto, 0x60, "Encryption key 2");
PARAM_DEFINE_STATIC_VMEM(PARAMID_CRYPTO_KEY3,              crypto_key3,             PARAM_TYPE_DATA,   32, sizeof(uint8_t),  PM_HWREG | PM_CRYPT, crypto_key_generate, NULL, crypto, 0x80, "Encryption key 3");
